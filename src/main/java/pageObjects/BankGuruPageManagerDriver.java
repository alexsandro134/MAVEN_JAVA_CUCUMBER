...
public class BankGuruPageManagerDriver {
	...
	public static CustomerRegisterSuccessfulPO getCustomerRegisterSuccessfulPage(WebDriver driver) {
	...
	public static EditCustomerDetailPO getEditCustomerDetaiPage(WebDriver driver) {
	...
	public static EditCustomerSuccessfulPO getEditCustomerSuccessfulPage(WebDriver driver) {
	...
	public static NewAccountCreateSuccessfulPO getNewAccountCreateSuccessful(WebDriver driver) {
	...
	public static DepositSuccessfulPagePO getDepositSuccessfulPage(WebDriver driver) {
	...
	public static WithdrawSuccessfulPagePO getWithdrawSuccessfulPage(WebDriver driver) {
	...
	public static FundTransferSuccessfulPO getFundTransferSuccessfulPage(WebDriver driver) {
	...
	public static BalanceEnquiryDetailPagePO getBalanceEnquiryDetailPage(WebDriver driver) {
	...
	public static DeleteAccountSuccessfulPagePO getDeteleAccountSuccessfulPage(WebDriver driver) {
	...
	public static DeleteCustomerSuccessfulPagePO getDeteleCustomerSuccessfulPage(WebDriver driver) {
